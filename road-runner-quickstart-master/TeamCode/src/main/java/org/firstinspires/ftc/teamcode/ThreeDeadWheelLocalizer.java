...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1549.5698201287357; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1197.9948040692152; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1609.0104261674471; // x position of the perpendicular encoder (in tick units)
    }
